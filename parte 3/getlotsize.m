function [dimensione_lotto] = getlotsize(punto_vendita, distanza, costo_mantenimento_kl) 

    dimensione_lotto = 0;
    costo_unita_prodotto_min = 10000000000;
    for i = 1:size(punto_vendita, 1)
        [~, ~, ~, costo_unita_prodotto, ~] = silveremeal(punto_vendita, 39, 0.5, distanza, costo_mantenimento_kl, i); 
